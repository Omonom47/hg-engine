...
u16 sVioletCityMart[] = {
    ITEM_BLACK_BELT, ITEM_DAMP_ROCK, ITEM_HEAT_ROCK, 0xFFFF
};
...
u16 sGoldenrodDepartmentUpper2F[] = {
    ITEM_GREAT_BALL, ITEM_ULTRA_BALL, ITEM_HYPER_POTION, ITEM_MAX_POTION, ITEM_REVIVE,
    ITEM_FULL_HEAL, ITEM_SUPER_REPEL, ITEM_MAX_REPEL, ITEM_SILVER_POWDER,
    ITEM_ABILITY_CAPSULE, ITEM_LUCKY_EGG, 0xFFFF
};
   
u16 sGoldenrodDepartmentLower2F[] = {
    ITEM_MAGMARIZER, ITEM_ELECTIRIZER, ITEM_PROTECTOR, ITEM_KINGS_ROCK, ITEM_DRAGON_SCALE,
    ITEM_RAZOR_CLAW, ITEM_RAZOR_FANG, ITEM_PRISM_SCALE, ITEM_OVAL_STONE, ITEM_UP_GRADE,
    ITEM_DUBIOUS_DISC, ITEM_METAL_COAT, ITEM_REAPER_CLOTH, 0xFFFF
};

u16 sGoldenrodDepartment3F[] = {
    ITEM_LONELY_MINT, ITEM_ADAMANT_MINT, ITEM_NAUGHTY_MINT, ITEM_BRAVE_MINT, ITEM_BOLD_MINT,
    ITEM_IMPISH_MINT, ITEM_LAX_MINT, ITEM_RELAXED_MINT, ITEM_MODEST_MINT, ITEM_MILD_MINT, 
    ITEM_RASH_MINT, ITEM_QUIET_MINT, ITEM_CALM_MINT, ITEM_GENTLE_MINT, ITEM_CAREFUL_MINT,
    ITEM_SASSY_MINT, ITEM_TIMID_MINT, ITEM_HASTY_MINT, ITEM_JOLLY_MINT, ITEM_NAIVE_MINT,
...
u16 sGoldenrodDepartment5F[] = {
    ITEM_TM092, ITEM_TM017, ITEM_TM077, ITEM_TM041, ITEM_TM016,
...
u16 sEcruteakMart[] = {
    ITEM_ICY_ROCK, ITEM_SMOOTH_ROCK, ITEM_NET_BALL, 0xFFFF
};
...
u16 sMahoganyPostRocketHideout[] = {
    ITEM_TOXIC_ORB, ITEM_FLAME_ORB, ITEM_TM013, ITEM_TM024, ITEM_TM029,
    ITEM_TM035, ITEM_TM074, ITEM_TM081, 0xFFFF
};
